...
void renderEntities(GameState *gameState, glm::mat4 glmView, glm::mat4 glmProjection, bool32 colorPicking)
{
    glm::mat4 glmModel;
        ...
        x++)
    {
            ...
            ++m)
        {
            ...
            if(!colorPicking)
            {
                shaderProgram = rr->shaders[rm->rri.shaderIndex].program;
